...
$requiredFiles = @(
    ...
    (Join-Path $iosRoot 'MoneySnap\Features\Home\TodayCanvasPlacement.swift'),
    (Join-Path $iosRoot 'MoneySnap\Features\Home\TodayCanvasDrift.swift'),
    (Join-Path $iosRoot 'MoneySnap\Features\Home\TodayCanvasScene.swift'),
    ...
    (Join-Path $iosRoot 'MoneySnap\Features\Profile\HelpGuideView.swift'),
    (Join-Path $iosRoot 'MoneySnapTests\HelpTopicTests.swift'),
    ...
    (Join-Path $iosRoot 'MoneySnap\Features\Archive\ArchiveCalendar.swift'),
    (Join-Path $iosRoot 'MoneySnap\Features\Archive\ArchiveViewModel.swift'),
    (Join-Path $iosRoot 'MoneySnapTests\ArchiveViewModelTests.swift'),
...
$expectedSourceNames = @(
    ...
    'TodayCanvasPlacement.swift',
    'TodayCanvasScene.swift',
    'TodayCanvasView.swift',
    'TodayCanvasPlacementTests.swift',
