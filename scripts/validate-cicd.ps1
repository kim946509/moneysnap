...
Require-Match -Content $iosTestflight -Pattern 'CODE_SIGNING_ALLOWED=NO' -Description 'TestFlight archive skips local Development signing'
Require-Match -Content $iosTestflight -Pattern 'CODE_SIGNING_REQUIRED=NO' -Description 'TestFlight archive does not require a local certificate'
