...
class GroupHttpIntegrationTests {
    ...
    void resetDatabase() {
        ...
        jdbc.sql("TRUNCATE TABLE snap_share_mutations, snap_shares, group_join_mutations, group_invites, "
                + "group_delete_mutations, group_create_mutations, group_memberships, spend_groups, "
                + "snap_delete_mutations, snap_revise_mutations, snap_record_mutations, snaps, "
    ...
    void ownerCreatesListsAndDeletesAGroupWithoutTouchingPersonalSnaps() throws Exception {
        ...
        String snapId = jdbc.sql("SELECT id FROM snaps").query(UUID.class).single().toString();
